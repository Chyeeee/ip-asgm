...
RESULT_FOLDER = "Results/Gaussian"
...
def find_first_image(folder):
    ...
    # Sort so other filtering files can use the SAME image
    image_paths.sort()
...
def calculate_noise_reduction(original, filtered):
    ...
    # Laplacian variance measures high-frequency information
...
def create_roi_mask(image):
    ...
    # Assume fruit is mainly inside image
    ...
    # Convert GrabCut result into binary mask
...
def calculate_roi_score(filtered, roi_mask):
    ...
    # Compare ROI boundary with image edges
    boundary_pixels = (
        boundary > 0
    )
...
# ============================================================
# 11. CREATE SEGMENTED FRUIT IMAGE
# ============================================================
...
# ============================================================
# 13. CREATE ONE RESULT COMPARISON IMAGE
# ============================================================
...
comparison_path = os.path.join(
    RESULT_FOLDER,
    "gaussian_result_comparison.png"
)
