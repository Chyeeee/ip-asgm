...
def find_first_image(folder):
    ...
    # Sort so all four filters use the SAME image
    image_paths.sort()
...
# ============================================================
# 13. CREATE RESULT COMPARISON IMAGE
# ============================================================
